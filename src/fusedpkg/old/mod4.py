...
class GridSearch_Generalised:
    ...
    def fit_one_lambda(self,data,inputs,lbd_fused,lbd_group):
        ...
        prob, beta, intercept, lam  = compute_group_lasso_glm(data,
                                                                inputs,
                                                                self.target,
                                                                self.offset,
                                                                self.penalty_types,
    ...
    def crossval_pair_lambdas(self,
        ...
        # If nothing was precomputed, fall back to computing here (optional)
    ...
    @time_it
    def test_grouping_variables(self, grouped_lasso_table, lambda_group_temp, counter,prob, beta, intercept, lam):
    ...
    def get_lambda_curve(self):
        ...
        print('----------------------------------\n')
        prob, beta, intercept, lam  = compute_group_lasso_glm(self.data_onehot,
                                                              self.input_variables,
                                                              self.target,
                                                              self.offset,
                                                              self.penalty_types,
